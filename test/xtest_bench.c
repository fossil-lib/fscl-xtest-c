...
{
    xtest_run_test(&comput_bubble_sort_small_dataset, runner);
    xtest_run_test(&comput_bubble_sort_medium_dataset, runner);
    xtest_run_test(&comput_bubble_sort_large_dataset, runner);
