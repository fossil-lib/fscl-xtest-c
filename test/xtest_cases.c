...
void xfixture_basic_cases(XUnitRunner *runner)
{
    ...
    xtest_run_test_unit(&basic_run_of_int32, &runner->stats);
    xtest_run_test_unit(&basic_run_of_int64, &runner->stats);
    xtest_run_test_unit(&basic_run_of_uint, &runner->stats);
    xtest_run_test_unit(&basic_run_of_uint8, &runner->stats);
    xtest_run_test_unit(&basic_run_of_uint16, &runner->stats);
    xtest_run_test_unit(&basic_run_of_uint32, &runner->stats);
    xtest_run_test_unit(&basic_run_of_uint64, &runner->stats);
    xtest_run_test_unit(&basic_run_of_hex, &runner->stats);
    xtest_run_test_unit(&basic_run_of_hex8, &runner->stats);
    xtest_run_test_unit(&basic_run_of_hex16, &runner->stats);
    xtest_run_test_unit(&basic_run_of_hex32, &runner->stats);
    xtest_run_test_unit(&basic_run_of_hex64, &runner->stats);
    xtest_run_test_unit(&basic_run_of_oct, &runner->stats);
    xtest_run_test_unit(&basic_run_of_bit, &runner->stats);
    xtest_run_test_unit(&basic_run_of_float, &runner->stats);
    xtest_run_test_unit(&basic_run_of_double, &runner->stats);
    xtest_run_test_unit(&basic_run_of_string, &runner->stats);
    xtest_run_test_unit(&basic_run_of_pointer, &runner->stats);
    xtest_run_test_unit(&basic_run_of_boolean, &runner->stats);
    
    xtest_run_test_unit(&xexpect_run_of_int, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_int8, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_int16, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_int32, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_int64, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_uint, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_uint8, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_uint16, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_uint32, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_uint64, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_hex, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_hex8, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_hex16, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_hex32, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_hex64, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_oct, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_bit, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_float, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_double, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_string, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_pointer, &runner->stats);
    xtest_run_test_unit(&xexpect_run_of_boolean, &runner->stats);
