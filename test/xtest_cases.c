...
{
    xtest_run_test(&basic_run_of_int, runner);
    xtest_run_test(&basic_run_of_int8, runner);
    xtest_run_test(&basic_run_of_int16, runner);
    xtest_run_test(&basic_run_of_int32, runner);
    xtest_run_test(&basic_run_of_int64, runner);
    xtest_run_test(&basic_run_of_uint, runner);
    xtest_run_test(&basic_run_of_uint8, runner);
    xtest_run_test(&basic_run_of_uint16, runner);
    xtest_run_test(&basic_run_of_uint32, runner);
    xtest_run_test(&basic_run_of_uint64, runner);
    xtest_run_test(&basic_run_of_hex, runner);
    xtest_run_test(&basic_run_of_hex8, runner);
    xtest_run_test(&basic_run_of_hex16, runner);
    xtest_run_test(&basic_run_of_hex32, runner);
    xtest_run_test(&basic_run_of_hex64, runner);
    xtest_run_test(&basic_run_of_oct, runner);
    xtest_run_test(&basic_run_of_bit, runner);
    xtest_run_test(&basic_run_of_float, runner);
    xtest_run_test(&basic_run_of_double, runner);
    xtest_run_test(&basic_run_of_string, runner);
    xtest_run_test(&basic_run_of_pointer, runner);
    xtest_run_test(&basic_run_of_boolean, runner);
    
    xtest_run_test(&xexpect_run_of_int, runner);
    xtest_run_test(&xexpect_run_of_int8, runner);
    xtest_run_test(&xexpect_run_of_int16, runner);
    xtest_run_test(&xexpect_run_of_int32, runner);
    xtest_run_test(&xexpect_run_of_int64, runner);
    xtest_run_test(&xexpect_run_of_uint, runner);
    xtest_run_test(&xexpect_run_of_uint8, runner);
    xtest_run_test(&xexpect_run_of_uint16, runner);
    xtest_run_test(&xexpect_run_of_uint32, runner);
    xtest_run_test(&xexpect_run_of_uint64, runner);
    xtest_run_test(&xexpect_run_of_hex, runner);
    xtest_run_test(&xexpect_run_of_hex8, runner);
    xtest_run_test(&xexpect_run_of_hex16, runner);
    xtest_run_test(&xexpect_run_of_hex32, runner);
    xtest_run_test(&xexpect_run_of_hex64, runner);
    xtest_run_test(&xexpect_run_of_oct, runner);
    xtest_run_test(&xexpect_run_of_bit, runner);
    xtest_run_test(&xexpect_run_of_float, runner);
    xtest_run_test(&xexpect_run_of_double, runner);
    xtest_run_test(&xexpect_run_of_string, runner);
    xtest_run_test(&xexpect_run_of_pointer, runner);
    xtest_run_test(&xexpect_run_of_boolean, runner);
    
    xtest_run_test(&xbdd_logic_test, runner);
    xtest_run_test(&xbdd_user_account, runner);
    xtest_run_test(&xbdd_empty_cart, runner);
    xtest_run_test(&xbdd_valid_login, runner);
} // end of fixture
